#!/usr/bin/env python3
"""
Script corrigido para migrar dados da planilha CSV para o banco PostgreSQL
"""
import csv
import psycopg2
import os
...
def corrigir_estrutura_tabelas():
    """Corrige a estrutura das tabelas para suportar dados maiores"""
    ...
    try:
        ...
        cursor.execute("ALTER TABLE alunos ALTER COLUMN telefone TYPE VARCHAR(50)")
        print("✅ Campo telefone corrigido")
        
        # Alterar tamanho do campo nome
        cursor.execute("ALTER TABLE alunos ALTER COLUMN nome TYPE VARCHAR(200)")
        print("✅ Campo nome corrigido")
        
        # Alterar tamanho do campo endereco
        cursor.execute("ALTER TABLE alunos ALTER COLUMN endereco TYPE TEXT")
        print("✅ Campo endereco corrigido")
...
def limpar_telefone(telefone):
    ...
    # Retorna o telefone limpo (máximo 50 caracteres)
    return telefone_limpo[:50] if telefone_limpo else None
...
def migrar_dados_csv():
    ...
    # Primeiro corrigir estrutura das tabelas
    if not corrigir_estrutura_tabelas():
        return False
    ...
    try:
        ...
        cursor.execute("DELETE FROM atividades WHERE id > 5")  # Manter atividades básicas
        ...
        with open(arquivo_csv, 'r', encoding='utf-8') as arquivo:
            ...
            for linha in leitor:
                try:
                    ...
                    # Processar dados
                    nome = linha['gitNOME'].strip()[:200]  # Limitar a 200 caracteres
...
def main():
    """Função principal"""
    print("🚀 Iniciando migração de dados corrigida...")
